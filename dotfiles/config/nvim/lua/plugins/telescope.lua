...
vim.keymap.set('n', '<leader>gf', function() with_ivy(builtin.lsp_document_symbols)({ symbols = 'function' }) end)
vim.keymap.set('n', '<leader>gm', function() with_ivy(builtin.lsp_document_symbols)({ symbols = 'method' }) end)
vim.keymap.set('n', '<leader>gj', function() with_ivy(builtin.lsp_document_symbols)({}) end)
